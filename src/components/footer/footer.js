...
function Footer(props) {
    ...
    return (
        <div className="footerMainDiv">
            ...
            <Grid
                className="ContainerGridfooter"
                container
                spacing={3}

            >
                <Grid className="itemGridfooter" item xs={10} sm={10} lg={3}>
                    <img src={logo} />
                    < p style={{textAlign:"center"}}>Become the best, with these recommendations.</p>
                    <p>Reference site above.</p>
                    <p>

                        &copy;  2022     Devzware. All rights reserved
                    </p>
